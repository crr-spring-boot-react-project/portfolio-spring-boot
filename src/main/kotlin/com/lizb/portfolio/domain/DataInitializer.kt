package com.lizb.portfolio.domain

import com.lizb.portfolio.domain.constant.SkillType
import com.lizb.portfolio.domain.entity.*
import com.lizb.portfolio.domain.repository.*
...
class DataInitializer(
    ...
    fun initializeData() {
        log.info("스프링이 실행되었습니다. 테이스 테이터를 초기화 합니다.")
...
// skill 초기화
        ...
        project2.addDetails(
            mutableListOf(
                ...
                ProjectDetail(
                    content = "PIL(Pillow) 활용하여 이미지 분석 기능 개발2", url = null,
                    isActive = true
                ),
                ProjectDetail(
